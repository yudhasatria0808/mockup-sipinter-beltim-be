        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NomorSambungan = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", nullable: true),
                    Idx = table.Column<int>(type: "INTEGER", nullable: false),
                    ModulId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Pelanggan",
                columns: new[] { "Id", "Aktif", "Alamat", "CreatedAt", "Nama", "NoTelp", "NomorSambungan" },
                values: new object[,]
                {
                    { 1, true, "Jl. Merdeka No. 1", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Ahmad Sudirman", null, "001-001" },
                    { 2, true, "Jl. Pahlawan No. 5", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Siti Rahayu", null, "001-002" },
                    { 3, true, "Jl. Kartini No. 12", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Budi Santoso", null, "002-001" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Menus_ModulId",
                table: "Menus",
                column: "ModulId");
